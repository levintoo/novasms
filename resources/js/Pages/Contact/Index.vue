...
watch(params.value, debounce((params) => {
    router.get('/contact', { ...omitBy(params, v => v === "") }, { preserveScroll: true, replace: true, preserveState: true },)
},150));
...
<template>
            ...
            <Dropdown class="my-6">
                ...
                <template #content>
                    <ul aria-label="submenu">
                        <DropdownLink href="/contact/create" class="flex items-center">
                        ...
                        <DropdownLink href="/contact/upload" class="flex items-center" >
    ...
    <Table>
                ...
                <TableBody v-if="contacts.data.length > 0">
                    <TableBodyItem v-for="contact in contacts.data">
                        ...
                        <td class="text-center">
                            <IconLink :href="`/contact/edit/${contact.id}`"
            ...
            <template #pagination>
                <Pagination v-if="contacts.links" :from="contacts.from" :to="contacts.to" :total="contacts.total" :links="contacts.links" />
            </template>
        </Table>
</template>
