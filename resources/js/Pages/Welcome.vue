    ...
    <Head title="Welcome" />
        ...
        >
            ...
            <div
                ...
                class="fixed inset-0 z-10 flex sm:hidden items-end bg-black bg-opacity-50 sm:items-center sm:justify-center"
            ></div>
            <aside
                            ...
                            <li class="relative">
                                ...
                                <template v-if="isNotificationsMenuOpen">
                                    <ul
                                        ...
                                        x-transition:leave-start="opacity-100"
                                        x-transition:leave-end="opacity-0"
                                        @click="closeNotificationsMenu = !isNotificationsMenuOpen"
                            ...
                            <li class="relative">
                                ...
                                <template v-if="isProfileMenuOpen">
                                    <ul
                                        ...
                                        x-transition:leave-start="opacity-100"
                                        x-transition:leave-end="opacity-0"
                                        @click="closeProfileMenu = !isProfileMenuOpen"
