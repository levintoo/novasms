...
<template>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2">
        ...
        <span class="flex align-center justify-start sm:justify-end">
                        <div>
    ...
    <div class="rounded-md shadow-md bg-white my-3">
        <div class="flex">
            <div class="flex-1 py-5 pl-5 overflow-hidden text-md text-gray-900">
                <ul class="space-y-3">
                    <li>
